...
export default defineConfig({
  ...
  webServer: process.env.PLAYWRIGHT_USE_EXTERNAL_SERVERS
    ...
    : [
        {
          command:
            "MIN_PLAYERS=1 ROOM_CREATE_RATE_LIMIT=1000 RECONNECT_GRACE_MS=300 BOT_THINK_MIN_MS=30 BOT_THINK_MAX_MS=60 LOCAL_TRANSITION_DELAY_MS=20 DEALER_PICK_INTRO_MS=20 DEALER_REVEAL_INTRO_MS=20 OPENING_DEAL_DELAY_MS=80 npm --prefix server run start",
