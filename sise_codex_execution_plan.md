...
实现范围覆盖规则与版本恢复、匿名指标、教学/提示/邀请/复玩、文化页、App 八个领域拆分以及先审计后迁移生成文件。具体状态以产品化进度表的实际 PR 为准；规则与许可证已确认。真实设备、读屏与本地牌友验收迁入 #74；生产指标与部署由 #73 跟踪，最新结果以产品化进度为准。两个 milestone 按实际验收进度更新。
