  ...
  <div class="guide">
    ...
    <details :open="phase !== 'playing'">
      ...
      <ol>
        ...
        <li><strong>选择吃牌：</strong>点手牌选择要组成一组的牌，再点“吃”。上家出牌时可提前确认吃，同时放弃自己的胡、开、碰；其他玩家仍可优先截取。</li>
        <li><strong>需要出牌：</strong>点一张手牌，再点“出牌”。将、金条及为保留声明坎数而不能打出的牌标有“留”，不能主动打出。</li>
        <li><strong>不吃上家的牌：</strong>选择“抓”；抓出的牌先到桌面中央，其他玩家有机会响应。</li>
      </ol>
      <p>声明坎数不得超过手牌坎数，整局必须保留；坎转为开仍算保留。打开说明不会暂停牌局。剩余时间固定显示在手牌上方。</p>
    </details>
    <details :open="phase === 'playing'">
    ...
    <details :open="phase === 'playing'">
      ...
      <p>本站采用莆田地方玩法 v1.0。含鱼或开为大胡，否则为小胡。小胡赢家坐庄；大胡赢家对家翻牌定庄；流局原庄对家翻牌定庄，翻牌颜色决定新庄。</p>
      ...
      <p>选择吃牌组合时，系统会直接在“吃后打出即可听牌”的剩余手牌上标“听”，选好牌后，再点“吃”确认。</p>
    </details>
    <details>
...
details { border: 1px solid var(--ui-raised, #334155); border-radius: 10px; padding: 12px; background: var(--ui-raised, #111e30); }
...
.example strong { color: var(--ui-accent-text, #6ee7b7); }
.example strong.invalid { color: var(--ui-danger-text, #fda4af); }
