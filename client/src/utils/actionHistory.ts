const ACTOR_FIRST_PREFIXES = ["seat_", "bot_"] as const;
...
export function parseActionDescriptor(action: string): { actorId: string; actionKey: string } {
...
export function actionHistoryText(actionKey: string): string | null {
